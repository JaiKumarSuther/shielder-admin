  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
      ...
      <button
        ...
        className="w-full py-2 sm:py-3 px-3 sm:px-4 rounded-md text-blue-700 font-medium text-sm border border-blue-200 hover:bg-blue-50 transition-all duration-200 flex items-center justify-center"
      >
